...
export default function TopAgent() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 flex items-center justify-center px-6 py-10">
      <Toaster position="top-center" reverseOrder={false} />
      <motion.div
        initial={{ opacity: 0, y: 60 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="w-full max-w-6xl bg-white rounded-xl shadow-lg grid grid-cols-1 md:grid-cols-2 gap-10 p-10"
      >
        {/* Left Side - Image */}
        <motion.div
          whileHover="hover"
        ...
        <div className="flex flex-col justify-center space-y-4">
          ...
          <p className="text-gray-700 text-lg">
            Discover the top-rated agent of the month. This agent has earned the
            trust of many clients through dedication, quick responses, and
            excellent service.
          </p>
          ...
          <button
            ...
            className="mt-6 px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition w-fit"
          >
            Contact Agent
          </button>
        </div>
